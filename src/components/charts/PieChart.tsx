...
const PieChart = ({ title, value, series, colors } : PieChartProps) => {
  return (
    <Box
      ...
      bgcolor="#fcfcfc" pl={3.5} py={2} gap={2} borderRadius={"15px"} minHeight="110px" width="fit-content"
    >
      ...
      <ReactApexChart
        options={{ chart: {type: 'donut'}, colors, legend: { show: false }, dataLabels: { enabled: false } }}
